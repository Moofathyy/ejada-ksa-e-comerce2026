...
import { Search as SearchIcon, MapPin, Bell, ShoppingBag, ChevronDown, Mic, ScanLine, ChevronRight } from "lucide-react";
      ...
      <header className="sticky top-0 z-30 bg-primary text-n8 rounded-b-3xl shadow-elev1">
        <div className="px-4 pt-4 pb-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button className="relative w-10 h-10 flex items-center justify-center bg-n8/15 rounded-xl" aria-label="Notifications">
