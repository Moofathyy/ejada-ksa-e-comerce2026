      ...
      <main className="px-4 pt-4 pb-8 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3 pt-1">
          ...
          <Sheet>
            ...
            <SheetContent side="bottom" className="rounded-t-3xl bg-n8 mx-auto max-w-[402px] inset-x-0">
          ...
          <Sheet>
            ...
            <SheetContent side="bottom" className="rounded-t-3xl bg-n8 max-h-[85vh] overflow-y-auto mx-auto max-w-[402px] inset-x-0">
              <SheetHeader className="text-start">
                <SheetTitle className="text-h2 text-n1">
