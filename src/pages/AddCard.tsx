...
const baseInput = "w-full mt-1.5 h-12 px-4 bg-n8 border border-n5 rounded-input text-body text-n1 placeholder:text-n4 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition tabular";
